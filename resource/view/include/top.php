            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left header-dropdowns">
                        ...
                        <div class="header-dropdown">
                            <a href="#"><img src="public/assets/images/favicon/bd.png"
                                    alt="Bangladesh flag">BANGLADESH</a>
                            <div class="header-menu">
                                <ul>
                                    <li><a href="#"><img src="public/assets/images/favicon/fr.png"
                                                alt="France flag">VietNam</a></li>
                                    <li><a href="#"><img src="public/assets/images/favicon/en.png"
                ...
                <div class="container">
                    <div class="header-left">
                        <a href="index.php" class="logo">
                            <img style="height: 60px;" src="public/assets/images/favicon/logoFrontEnd.png"
                                alt="SuperShop Logo">
                        </a>
                    </div>
                        ...
                        <form action="search.php" method="post" style="margin-bottom: -8px;">
                            <div class="input-group" style="width: 100%; margin: 0px 60px;">
                                <input type="search" class="form-control" name="keywords" id="search"
                                    placeholder="Type your Search Keyword" required>
                                <div class="input-group-append">
                                    <button class="btn btn-sm btn-primary" type="submit"><i class="icon-magnifier"></i>
                                        SEARCH </button>
                                </div>
